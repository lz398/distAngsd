...
void Yanggradient (int n, const double x[], double f0, 
		   double g[],const void*dats, double (*fun)(const double x[],const void*), 
		   double space[],
...
void getgradient(int npar, const double invec[],
		 double outvec[],const void*dats, double(*func)(const double [],const void*), 
		 const double* lowbound, const double* upbound){
...
{
    /* Format strings */
  /*     char fmt_1002[] = "(/,\002At iterate\002,i5,4x,\002f= \002,1p,d12\
...
-\002,5x,\002-\002,5x,\002-\002,8x,\002-\002,3x,1p,2(1x,d10.3))";
     char fmt_1001[] = "(//,\002ITERATION \002,i5)";
     char fmt_1005[] = "(/,\002 Singular triangular system detected\
;\002,/,\002   refresh the lbfgs memory and restart the iteration.\002)";
     char fmt_1006[] = "(/,\002 Nonpositive definiteness in Cholesky f\
actorization in formk;\002,/,\002   refresh the lbfgs memory and restart the\
 iteration.\002)";
     char fmt_1008[] = "(/,\002 Bad direction in the line search;\002,\
/,\002   refresh the lbfgs memory and restart the iteration.\002)";
     char fmt_1004[] = "(\002  ys=\002,1p,e10.3,\002  -gs=\002,1p,e10.\
3,\002 BFGS update SKIPPED\002)";
     char fmt_1007[] = "(/,\002 Nonpositive definiteness in Cholesky f\
...
int freev_(integer *n, integer *nfree, integer *index, integer *nenter, integer *ileave, integer *indx2, integer *iwhere, logical *wrk, logical *updatd, logical *cnstnd, integer *iprint, integer *iter);
int dcopy_(integer *n, doublereal *dx, integer *incx, doublereal *dy, integer *incy);
     doublereal dnorm;
     //    extern /* Subroutine */ int formk_();
int formk_(integer *n, integer *nsub, integer *ind, integer *nenter, integer *ileave, integer *indx2, integer *iupdat, logical *updatd, doublereal *wn, doublereal *wn1, integer *m, doublereal *ws, doublereal *wy, doublereal *sy, doublereal *theta, integer *col, integer *head, integer *info);
     integer nskip, iword;
     //    extern /* Subroutine */ int formt_(), subsm_();
int formt_(integer *m, doublereal *wt, doublereal *sy, doublereal *ss, integer *col, doublereal *theta, integer *info);

int subsm_(integer *n, integer *m, integer *nsub, integer *ind, doublereal *l, doublereal *u, integer *nbd, doublereal *x, doublereal *d__, doublereal *ws, doublereal *wy, doublereal *theta, integer *col, integer *head, integer *iword, doublereal *wv, doublereal *wn, integer *iprint, integer *info);
...
int active_(integer *n, doublereal *l, doublereal *u, integer *nbd, doublereal *x, integer *iwhere, integer *iprint, logical *prjctd, logical *cnstnd, logical *boxed);
     logical prjctd;
     integer iupdat;
...
int projgr_(integer *n, doublereal *l, doublereal *u, integer *nbd, doublereal *x, doublereal *g, doublereal *sbgnrm);
     doublereal dtd;
     integer col;
     doublereal tol;
     logical wrk;
    ...
    /* Fortran I/O blocks */
    /*     cilist io___62 = { 0, 6, 0, fmt_1002, 0 };
     cilist io___63 = { 0, 0, 0, fmt_1003, 0 };
     cilist io___64 = { 0, 6, 0, fmt_1001, 0 };
     cilist io___66 = { 0, 6, 0, fmt_1005, 0 };
     cilist io___68 = { 0, 6, 0, fmt_1006, 0 };
     cilist io___69 = { 0, 6, 0, fmt_1005, 0 };
     cilist io___71 = { 0, 6, 0, fmt_1008, 0 };
     cilist io___75 = { 0, 6, 0, fmt_1004, 0 };
     cilist io___76 = { 0, 6, 0, fmt_1007, 0 };*/
...
/* ======================= The end of mainlb ============================= */
/* Subroutine */ int active_(int *n,double * l,double * u,int * nbd,double* x,int* iwhere,int * iprint,logical* prjctd,logical* cnstnd, logical *boxed)
		 /*
integer *n;
doublereal *l, *u;
integer *nbd;
...
{
    /* Format strings */
  //     char fmt_1001[] = "(/,\002At X0 \002,i9,\002 variables are exactly at the bounds\002)";
    ...
    /* Fortran I/O blocks */
    /*     cilist io___81 = { 0, 6, 0, 0, 0 };
     cilist io___82 = { 0, 6, 0, 0, 0 };
     cilist io___83 = { 0, 6, 0, fmt_1001, 0 };*/
...
/* L20: */
 ...
 e_wsle();*/
	...
	if (! (*cnstnd)) {
	  printf("The problem is unconstrained\n");
	  /*	    s_wsle(&io___82);
...
/* ======================= The end of active ============================= */
/* Subroutine */ int bmv_(int *m,double * sy,double * wt,int * col,double * v,double * p,int * info)
		 /*
integer *m;
doublereal *sy, *wt;
integer *col;
...
/* ======================== The end of bmv =============================== */
/* Subroutine */ int cauchy_(int *n,double * x,double * l,double * u,int * nbd,double * g,int * iorder,int * iwhere,double * t,double * d__,double * xcp, 
	int *m,double * wy,double * ws,double * sy,double * wt,double * theta,int * col,int * head,double * p,double * c__,double * wbp,double * v,int * nint,double * sg,double * yg, 
	int *iprint,double * sbgnrm,int * info)
		 /*
integer *n;
doublereal *x, *l, *u;
integer *nbd;
...
int bmv_(integer *m, doublereal *sy, doublereal *wt, integer *col, doublereal *v, doublereal *p, integer *info);
     doublereal wmc, wmp, wmw;
     integer col2;

    /* Fortran I/O blocks */
    /*     cilist io___88 = { 0, 6, 0, 0, 0 };
     cilist io___96 = { 0, 6, 0, fmt_3010, 0 };
     cilist io___105 = { 0, 6, 0, fmt_1010, 0 };
     cilist io___109 = { 0, 6, 0, 0, 0 };
     cilist io___116 = { 0, 6, 0, fmt_4011, 0 };
     cilist io___117 = { 0, 6, 0, fmt_5010, 0 };
     cilist io___118 = { 0, 6, 0, fmt_6010, 0 };
     cilist io___121 = { 0, 6, 0, 0, 0 };
     cilist io___126 = { 0, 6, 0, 0, 0 };
     cilist io___127 = { 0, 6, 0, 0, 0 };
     cilist io___128 = { 0, 6, 0, fmt_4010, 0 };
     cilist io___129 = { 0, 6, 0, fmt_6010, 0 };
     cilist io___130 = { 0, 6, 0, fmt_1010, 0 };
     cilist io___131 = { 0, 6, 0, fmt_2010, 0 };*/
...
/* ====================== The end of cauchy ============================== */
/* Subroutine */ int cmprlb_(int *n,int * m,doublereal * x,doublereal * g,doublereal * ws,doublereal * wy,doublereal * sy,doublereal * wt,doublereal * z__,doublereal * r__,doublereal * wa,int * index,doublereal * theta,int * col,int * head,int * nfree,logical * cnstnd, int *info)/*
integer *n, *m;
...
/* ======================= The end of errclb ============================= */
/* Subroutine */ int formk_(int *n,integer * nsub,integer * ind,integer * nenter,integer * ileave,integer * indx2,integer * iupdat, 
	logical *updatd,double * wn,double * wn1,int * m,double * ws,double * wy,double * sy,double * theta,int * col,int * head,int * info)/*
...
/* ======================= The end of formk ============================== */
/* Subroutine */ int formt_(int *m, double *wt,double * sy,double * ss,int * col,double * theta,int * info)/*
integer *m;
doublereal *wt, *sy, *ss;
integer *col;
doublereal *theta;
...
/* ======================= The end of formt ============================== */
/* Subroutine */ int freev_(int *n,int * nfree,int * index,int * nenter,int * ileave,int * indx2,int * iwhere, 
	logical *wrk,logical * updatd,logical * cnstnd,int * iprint,int * iter)/*
...
integer *iprint, *iter;*/
{
    ...
    /* Fortran I/O blocks */
    /*     cilist io___168 = { 0, 6, 0, 0, 0 };
     cilist io___169 = { 0, 6, 0, 0, 0 };
     cilist io___170 = { 0, 6, 0, 0, 0 };
     cilist io___172 = { 0, 6, 0, 0, 0 };*/
...
/* ======================= The end of freev ============================== */
/* Subroutine */ int hpsolb_(int *n,double * t,int * iorder,int * iheap)/*
integer *n;
doublereal *t;
...
/* ======================= The end of lnsrlb ============================= */
/* Subroutine */ int matupd_(int *n,int * m,double * ws,double * wy,double * sy,double * ss,double * d__,double * r__,int * itail,int * iupdat, 
	int *col,int * head,double * theta,double *rr,double * dr,double * stp,double * dtd)/*
integer *n, *m;
...
/* ======================= The end of matupd ============================= */
/* Subroutine */ int prn1lb_(int *n,int * m,double * l,double * u,double * x,int * iprint,int * itfile,double * epsmch)/*
integer *n, *m;
doublereal *l, *u, *x;
...
the projected gradient\002,/,\002f     = function value\002,/,/,\002        \
   * * *\002,/,/,\002Machine precision =\002,1p,d10.3)";
     char fmt_9001[] = "(/,3x,\002it\002,3x,\002nf\002,2x,\002nint\002\
...
\002,5x,\002projg\002,8x,\002f\002)";
 char fmt_1004[] = "(/,a4,1p,6(1x,d11.4),/,(4x,1p,6(1x,d11.4)))";*/
  ...
  //    integer s_wsfe(), do_fio(), e_wsfe(), s_wsle(), do_lio(), e_wsle();
    ...
    /* Fortran I/O blocks */
    /*     cilist io___185 = { 0, 6, 0, fmt_7001, 0 };
     cilist io___186 = { 0, 6, 0, 0, 0 };
     cilist io___187 = { 0, 0, 0, fmt_2001, 0 };
     cilist io___188 = { 0, 0, 0, 0, 0 };
     cilist io___189 = { 0, 0, 0, fmt_9001, 0 };
     cilist io___190 = { 0, 6, 0, fmt_1004, 0 };
     cilist io___192 = { 0, 6, 0, fmt_1004, 0 };
     cilist io___193 = { 0, 6, 0, fmt_1004, 0 };*/
...
.5,4x,\002|proj g|= \002,1p,d12.5)";
    ...
    /* Fortran I/O blocks */
    /*     cilist io___194 = { 0, 6, 0, 0, 0 };
     cilist io___195 = { 0, 6, 0, fmt_2001, 0 };
     cilist io___196 = { 0, 6, 0, fmt_1004, 0 };
     cilist io___198 = { 0, 6, 0, fmt_1004, 0 };
     cilist io___200 = { 0, 6, 0, fmt_2001, 0 };
     cilist io___201 = { 0, 0, 0, fmt_3001, 0 };*/
...
/* Subroutine */ int prn3lb_(int *n,double * x,double * f,char * task,int * iprint,integer * info,integer * itfile,integer * iter,integer * nfgv, 
	integer *nintol,integer * nskip,integer * nact,doublereal * sbgnrm,doublereal * time,int * nint,char * word, int *iback,double * stp,double * xstep,int * k, 
			     double *cachyt, double *sbtime, double *lnscht, ftnlen task_len,ftnlen word_len)/*
integer *n;
doublereal *x, *f;
char *task;
...
nction value\002,/,/,\002           * * *\002)";
     char fmt_3004[] = "(/,3x,\002N\002,3x,\002Tit\002,2x,\002Tnf\002,\
2x,\002Tnint\002,2x,\002Skip\002,2x,\002Nact\002,5x,\002Projg\002,8x,\002\
F\002)";
     char fmt_3005[] = "(i5,2(1x,i4),(1x,i6),(2x,i4),(1x,i5),1p,2(2x,d\
10.3))";
     char fmt_1004[] = "(/,a4,1p,6(1x,d11.4),/,(4x,1p,6(1x,d11.4)))";
     char fmt_3009[] = "(/,a60)";
...
nds.\002,/)";
    ...
    /* Fortran I/O blocks */
    /*     cilist io___202 = { 0, 6, 0, fmt_3003, 0 };
     cilist io___203 = { 0, 6, 0, fmt_3004, 0 };
     cilist io___204 = { 0, 6, 0, fmt_3005, 0 };
     cilist io___205 = { 0, 6, 0, fmt_1004, 0 };
     cilist io___207 = { 0, 6, 0, 0, 0 };
     cilist io___208 = { 0, 6, 0, fmt_3009, 0 };
     cilist io___209 = { 0, 6, 0, fmt_9011, 0 };
     cilist io___210 = { 0, 6, 0, fmt_9012, 0 };
     cilist io___211 = { 0, 6, 0, fmt_9013, 0 };
     cilist io___212 = { 0, 6, 0, fmt_9014, 0 };
     cilist io___213 = { 0, 6, 0, fmt_9015, 0 };
     cilist io___214 = { 0, 6, 0, 0, 0 };
     cilist io___215 = { 0, 6, 0, 0, 0 };
     cilist io___216 = { 0, 6, 0, fmt_9018, 0 };
     cilist io___217 = { 0, 6, 0, fmt_9019, 0 };
     cilist io___218 = { 0, 6, 0, fmt_3007, 0 };
     cilist io___219 = { 0, 6, 0, fmt_3008, 0 };
     cilist io___220 = { 0, 0, 0, fmt_3002, 0 };
     cilist io___221 = { 0, 0, 0, fmt_3009, 0 };
     cilist io___222 = { 0, 0, 0, fmt_9011, 0 };
     cilist io___223 = { 0, 0, 0, fmt_9012, 0 };
     cilist io___224 = { 0, 0, 0, fmt_9013, 0 };
     cilist io___225 = { 0, 0, 0, fmt_9014, 0 };
     cilist io___226 = { 0, 0, 0, fmt_9015, 0 };
     cilist io___227 = { 0, 0, 0, fmt_9018, 0 };
     cilist io___228 = { 0, 0, 0, fmt_9019, 0 };
     cilist io___229 = { 0, 0, 0, fmt_3008, 0 };*/
...
/* ======================= The end of prn3lb ============================= */
/* Subroutine */ int projgr_(int *n,double * l,double * u,int * nbd,double * x,double * g,double * sbgnrm)/*
integer *n;
doublereal *l, *u;
integer *nbd;
...
/* ======================= The end of projgr ============================= */
/* Subroutine */ int subsm_(int *n,int * m,int * nsub,int * ind,double * l,double * u,int * nbd,double * x,double * d__,double * ws,double * wy,double * theta,
...
-------\002,/)";
     char fmt_1002[] = "(\002ALPHA = \002,f7.5,\002 backtrack to the B\
OX\002)";
     char fmt_1003[] = "(\002Subspace solution X =  \002,/,(4x,1p,6(1x\
,d11.4)))";
...
int dtrsl_(doublereal *t, integer *ldt, integer *n, doublereal *b, integer *job, integer *info);
    ...
    /*     cilist io___232 = { 0, 6, 0, fmt_1001, 0 };
     cilist io___246 = { 0, 6, 0, fmt_1002, 0 };
     cilist io___247 = { 0, 6, 0, 0, 0 };
     cilist io___248 = { 0, 6, 0, fmt_1003, 0 };
     cilist io___249 = { 0, 6, 0, fmt_1004, 0 };*/
...
int dcstep_(doublereal *stx, doublereal *fx, doublereal *dx, doublereal *sty, doublereal *fy, doublereal *dy, doublereal *stp, doublereal *fp, doublereal *dp, logical *brackt, doublereal *stpmin, doublereal *stpmax);
...
/* ====================== The end of dcsrch ============================== */
/* Subroutine */ int dcstep_(doublereal *stx,doublereal * fx,doublereal * dx,doublereal * sty,doublereal * fy,doublereal * dy,doublereal * stp,doublereal * fp,doublereal * dp,logical * brackt,double *stpmin,double * stpmax)/*
...
/* ====================== The end of timer =============================== */
doublereal dnrm2_(int *n, double *x,int* incx)/*
integer *n;
doublereal *x;
integer *incx;*/
{
...
/* ====================== The end of ddot ================================ */
/* Subroutine */ int dpofa_(double *a,int * lda,int * n, int *info)/*
doublereal *a;
integer *lda, *n, *info;*/
{
    /* System generated locals */
...
/* ====================== The end of dscal =============================== */
/* Subroutine */ int dtrsl_(double *t,int * ldt,int * n,double * b,int * job,int* info)/*
doublereal *t;
integer *ldt, *n;
doublereal *b;
integer *job, *info;*/
